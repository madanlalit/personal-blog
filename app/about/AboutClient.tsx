        ...
        <div className="about-container fade-in">
                ...
                <div className="hero-layout">
                    <div className="hero-main">
                        ...
                        <div className="hero-actions">
                            <Link href="/experience" className="hero-btn primary">View Experience <ArrowRight size={14} /></Link>
            ...
            <Frame label="EXECUTION_LOG" className="experience-frame">
                <div className="exp-header">
                    ...
                    <Link href="/experience" className="view-all-link">View Full History <ArrowRight size={14} /></Link>
                </div>
